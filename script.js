...
const SOTD_CURATED = [
  // Lo-fi / chill
  { id:'4cOdK2wGLETKBW3PvgPWqT', title:'Clair de Lune – Debussy', mood:'🌙 Dreamy' },
  { id:'0wwPcA6wtMf6HUMpIRdeP7', title:'Comptine d\'un autre été – Yann Tiersen', mood:'🌧️ Melancholic' },
  { id:'4RVwu0g32PAqgUiJoXsdF8', title:'Experience – Ludovico Einaudi', mood:'✨ Peaceful' },
  { id:'5UqCQaDGkfEGTYXxuCSRTd', title:'River Flows in You – Yiruma', mood:'💧 Calm' },
  { id:'3n3Ppam7vgaVa1iaRUIOKE', title:'Photograph – Ed Sheeran', mood:'💛 Nostalgic' },
  { id:'7qiZfU4dY1lWllzX7mPBI3', title:'Shape of You – Ed Sheeran', mood:'🎉 Upbeat' },
  { id:'0tgVpDi06FyKpA1z0VMD4v', title:'Perfect – Ed Sheeran', mood:'💖 Romantic' },
  { id:'60nZcImufyMA1MKQY3dcCH', title:'Starboy – The Weeknd', mood:'🌃 Night Vibes' },
  { id:'0VjIjW4GlUZAMYd2vXMi3b', title:'Blinding Lights – The Weeknd', mood:'🌟 Energetic' },
  { id:'6UelLqGlWMcVH1E5c4H7lY', title:'Watermelon Sugar – Harry Styles', mood:'☀️ Sunny' },
  { id:'1dGr1c8CrMLDpV6mPbImSI', title:'As It Was – Harry Styles', mood:'🌈 Bittersweet' },
  { id:'4Dvkj6JhhA12EX05fT7y2e', title:'Flowers – Miley Cyrus', mood:'🌸 Empowering' },
  { id:'1BxfuPKGuaTgP7aM0Bbdwr', title:'Levitating – Dua Lipa', mood:'🚀 Feel Good' },
  { id:'2ekn2ttSfGqwhhate0LSR0', title:'New Rules – Dua Lipa', mood:'💪 Strong' },
  { id:'0pqnGHJpmpxLKifKRmU6WP', title:'Bad Guy – Billie Eilish', mood:'🖤 Dark Pop' },
  { id:'5XeFesFbtLpXzIVDNQP22n', title:'Happier – Olivia Rodrigo', mood:'💔 Bittersweet' },
  { id:'1zwMYTA5nlNjZxYrvBB2pV', title:'good 4 u – Olivia Rodrigo', mood:'😤 Cathartic' },
  { id:'0Jcij1eWd5bDMU5iPbxe2i', title:'drivers license – Olivia Rodrigo', mood:'🌧️ Emotional' },
  { id:'6AI3ezQ4o3HUoP6Dhudph3', title:'Anti-Hero – Taylor Swift', mood:'🌙 Introspective' },
  { id:'3CeCwYWvdfXbZLXFhBrbnf', title:'Cruel Summer – Taylor Swift', mood:'☀️ Summer' },
  { id:'7GX5flRQZVHza1Urgm4xTS', title:'Shake It Off – Taylor Swift', mood:'🎊 Fun' },
  { id:'1zi7xx7UVEFkmKfv06H8x0', title:'Someone Like You – Adele', mood:'🥺 Heartfelt' },
  { id:'4kflILqfa6R2pUMFW9QCZR', title:'Rolling in the Deep – Adele', mood:'🔥 Powerful' },
  { id:'2tznHmp70DxMyr2XhWLOW0', title:'Stay With Me – Sam Smith', mood:'💫 Soulful' },
  { id:'3t5xRXzsuZmMDkQzgOX55a', title:'Unholy – Sam Smith', mood:'🌑 Edgy' },
  { id:'6UDURqaq36MhXcVwzFwexm', title:'golden hour – JVKE', mood:'🌅 Romantic' },
  { id:'0nrRP4bk19rLc0orkWPVk2', title:'Dandelions – Ruth B.', mood:'🌼 Soft' },
  { id:'3ee8Jmje8o58CHK66QrVC2', title:'Peach – Kevin Abstract', mood:'🍑 Dreamy' },
  ...
  { id:'3CRDbSIZ4r5MsZ0YwxuEkn', title:'Motion Sickness – Phoebe Bridgers', mood:'🌊 Indie' },
  ...
  { id:'3YQKmKGau1PzlVlkL1iAx7', title:'Superstar – Conan Gray', mood:'🌟 Yearning' },
  { id:'0WOkYPQGVzDY3Qy7aMqsXg', title:'Die For You – The Weeknd', mood:'❤️‍🔥 Passionate' },
...
function loadSotd() {
  const saved = JSON.parse(localStorage.getItem(SOTD_KEY) || 'null');
  if (saved && saved.id) {
    renderSotd(saved.id, saved.type || 'track', saved.title || '', saved.mood || '');
  } else {
    shuffleSong();
  }
}
...
function renderSotd(id, type, title, mood) {
  ...
  // Fallback: show iframe after short delay even if onload doesn't fire
  setTimeout(() => { if (wrap.querySelector('.sotd-loading')) { wrap.innerHTML = ''; wrap.appendChild(iframe); } }, 1200);
  if (title) {
